...
<?php $form=$this->beginWidget('BActiveForm', array(
	...
	<div class="<?php echo $form->fieldClass($model, 'ejercicioFisca_did'); ?>">
		<?php echo $form->labelEx($model,'ejercicioFisca_did'); ?>
		<div class="input">
			
			<?php echo $form->dropDownList($model,ejercicioFisca_did,CHtml::listData(EjercicioFisca::model()->findAll(), 'id', 'nombre')); ?>			<?php echo $form->error($model,'ejercicioFisca_did'); ?>
		</div>
	</div>
