<table class="table table-bordered table-striped">
	<tr>
		...
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('sueldos')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('honorarios')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('combustibles')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('luzTelefono')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('papeleria')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('impuestosDerechos')); ?></b>
		</td>
		<?php /*
		<td >
